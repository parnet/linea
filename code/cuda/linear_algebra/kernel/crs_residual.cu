    ...
    cudaStream_t stream)
{
    ...
    cu_crs_residual_kernel<<<blocksPerGrid, threadsPerBlock,0,stream>>>(defect_values,num_rows, matrix_row_ptr, matrix_col_idx, matrix_a_values, x_values, rhs_values);
